...
Cube.__add__ = lambda self,other : Cube(self.x+other.x, self.y+other.y, self.z + other.z, self.w + other.w)
UNIT_CUBE = list(map(lambda t: Cube(*t),product(*repeat([-1,0,1],4))))
UNIT_NEIBORS = list(filter(lambda c : c != Cube(0,0,0,0),UNIT_CUBE))
ACTIVE = "#"
INACTIVE = "."
